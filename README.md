...
## About
Kocom Wallpad with RS485 for SK푸르지오 수원

## Installation

1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/peterkim21/kocom.py-1 를 입력한 다음 ADD 버튼을 누릅니다.
